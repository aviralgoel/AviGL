...
void render(void) {
	...
	//
	// Octant 1
	//int x1 = 100, x2 =200, y1 = 80, y2 = 80;
	//draw_line_BLA(x1, y1, x2, y2);
	//x1 = 100, x2 = 200, y1 = 80, y2 = 100;
	//draw_line_BLA(x1, y1, x2, y2);
	//x1 = 100, x2 = 200, y1 = 80, y2 = 160;
	//draw_line_BLA(x1,y1,x2,y2);
	//Octant 5
	double r = 280;
	int n = 10;
	int x = window_width / 2, y = window_height / 2;
	for (double i = 0; i < 2*3.14; i+=0.05)
	{
		int x1 = r * cos(i) + 640;
		int y1 = r * sin(i) + 320;
		draw_line_BLA(640, 320, x1, y1);
		//draw_line_DDA(640 , 320 , x1, y1);
	}
